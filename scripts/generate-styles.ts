...
// 7. Generate main-v4.css by inlining colors, fonts, shadows, typography, and tippy into template
...
// Remove import statements from template (colors, fonts, shadows, typography, tippy)
 ...
 *
 * Source: main-v4.template.css + colors.css + colors-v4.css + fonts-v4.css + shadows-v4.css + typography-v4.css + tippy-v4.css
