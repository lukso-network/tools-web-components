...
<div class="p-5 my-6 shadow-neutral-above-shadow rounded sb-unstyled">
  #### `desktop-sharp`
  <div class="flex gap-4 mt-8">
    <lukso-icon name="desktop-sharp" size="small"></lukso-icon>
    <lukso-icon name="desktop-sharp" size="medium"></lukso-icon>
    <lukso-icon name="desktop-sharp" size="large"></lukso-icon>
    <lukso-icon name="desktop-sharp" size="x-large"></lukso-icon>
  </div>
</div>
...
<div class="p-5 my-6 shadow-neutral-above-shadow rounded sb-unstyled">
  #### `logo-edge`
  <div class="flex gap-4 mt-8">
    <lukso-icon name="logo-edge" size="small"></lukso-icon>
    <lukso-icon name="logo-edge" size="medium"></lukso-icon>
    <lukso-icon name="logo-edge" size="large"></lukso-icon>
    <lukso-icon name="logo-edge" size="x-large"></lukso-icon>
  </div>
</div>
...
<div class="p-5 my-6 shadow-neutral-above-shadow rounded sb-unstyled">
  #### `logo-firefox`
  <div class="flex gap-4 mt-8">
    <lukso-icon name="logo-firefox" size="small"></lukso-icon>
    <lukso-icon name="logo-firefox" size="medium"></lukso-icon>
    <lukso-icon name="logo-firefox" size="large"></lukso-icon>
    <lukso-icon name="logo-firefox" size="x-large"></lukso-icon>
  </div>
</div>
...
<div class="p-5 my-6 shadow-neutral-above-shadow rounded sb-unstyled">
  #### `logo-opera`
  <div class="flex gap-4 mt-8">
    <lukso-icon name="logo-opera" size="small"></lukso-icon>
    <lukso-icon name="logo-opera" size="medium"></lukso-icon>
    <lukso-icon name="logo-opera" size="large"></lukso-icon>
    <lukso-icon name="logo-opera" size="x-large"></lukso-icon>
  </div>
</div>
...
<div class="p-5 my-6 shadow-neutral-above-shadow rounded sb-unstyled">
  #### `logo-safari`
  <div class="flex gap-4 mt-8">
    <lukso-icon name="logo-safari" size="small"></lukso-icon>
    <lukso-icon name="logo-safari" size="medium"></lukso-icon>
    <lukso-icon name="logo-safari" size="large"></lukso-icon>
    <lukso-icon name="logo-safari" size="x-large"></lukso-icon>
  </div>
</div>
