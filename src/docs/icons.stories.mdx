...
<div class="pt-4">
  <IconGallery>
    ...
    <IconItem name="edit-linear">
      <lukso-icon name="edit-linear" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="hexagon">
      <lukso-icon name="hexagon" size="medium"></lukso-icon>
    </IconItem>
    <IconItem name="image-linear">
      <lukso-icon name="image-linear" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="medal-star">
      <lukso-icon name="medal-star" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="minus">
      <lukso-icon name="minus" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="play-linear">
      <lukso-icon name="play-linear" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="profile-circle">
      <lukso-icon name="profile-circle" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="stop-linear">
      <lukso-icon name="stop-linear" size="medium"></lukso-icon>
    </IconItem>
    ...
    <IconItem name="user-circle-add">
      <lukso-icon name="user-circle-add" size="medium"></lukso-icon>
    </IconItem>
